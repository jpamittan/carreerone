...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::to('/site/css/datatables.css')}}"/>
...
@include('site.partials.dashboardheader')
...
<script type="text/javascript" src="{{URL::to('/site/js/candidate.js')}}"></script>
<script type="text/javascript" src="https://cdn.datatables.net/1.10.12/js/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="https://cdn.datatables.net/1.10.12/js/dataTables.bootstrap.min.js"></script>
<script src="{{URL::to('/site/js/profile.js')}}"></script>
<script src="{{URL::to('/site/js/skillassesment.js')}}"></script>
